# School Project: Digital Forensics- A Cybersecurity Investigation Project 🕵️‍♂️💻
...
- <b>📝 9: And it looks like he was trying to sell the proprietary data anonymously through the use of Bitcoin, 
...
- <b>📝 10: Lastly, l extracted some of the documents relevant to the invesƟgaƟon for further analysis.</b>
...
To wrap this investigation up, the team and I compiled a detailed report of our findings and 
important evidence. The investigation of the employee’s computer image reveals facts and signs that he 
violated the company rules through unauthorized access to confidential information. Additionally, the 
employee was looking into ways to make anonymous transactions using Bitcoin. This means he might 
have been trying to sell the company's confidential documents. So, in conclusion, the employee did 
...
- Why Digital Detectives are important: This project showed how digital detectives use special tools like Autopsy to find clues in computers when something fishy might be happening. It's like being a computer detective!

- Autopsy Does a Lot: Autopsy in the digital forensic world is like a superhero for computers. It can look at different kinds of computer files and things like searching for words, figuring out when activities happened, and even finding hidden files.
  
- Cybersecurity Measures: We found out that it's really important for companies to have special rules (like NDAs and AUPs) to keep their data safe. 
